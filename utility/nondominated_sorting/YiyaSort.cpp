...
namespace NDS {
	void YiyaSort::ObjectiveSortedGraphMergeChildrenSort(const std::vector<std::vector<double>>& data, std::vector<int>& dataRank) {
	...
	void YiyaSort::RankObjectiveLinkSort(const std::vector<std::vector<double>>& data, std::vector<int>& dataRank) {
		int nodeNum(data.size());
		if (nodeNum == 0)return;
	...
	bool YiyaSort::compareDominated(const std::vector<double>& father, const std::vector<double>& son, int objSize) {
	...
	int YiyaSort::compareDominated(const std::vector<double>& father, const std::vector<double>& son, int & fromIndex, int objSize) {
		int ret = 0;
