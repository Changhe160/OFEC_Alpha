...
namespace OFEC {
	...
	protected:
		solution_type m_pv, m_pu;    // donor vector and trial vector, respectively.
	public:
		...
		void recombine(double CR, const vector<int> &var, int I);
		void mutate(double F, const vector<int> &var, solution_type *r1,
			solution_type *r2,
			solution_type *r3,
			solution_type *r4 = 0,
			solution_type *r5 = 0);
		evaluation_tag select(const vector<int> &var, solution_type &best);
	};
	...
	template<typename VariableEncoding = variable<real>,
		typename ObjetiveType = real,
		typename ObjetiveCompare = objective_compare<ObjetiveType >>
	void DE_individual<VariableEncoding, ObjetiveType, ObjetiveCompare>::mutate(double F, const vector<int> &var, 
		solution_type *r1,
		solution_type *r2,
		solution_type *r3,
		solution_type *r4,
	...
	template<typename VariableEncoding = variable<real>,
		typename ObjetiveType = real,
		typename ObjetiveCompare = objective_compare<ObjetiveType >>
	void DE_individual<VariableEncoding, ObjetiveType, ObjetiveCompare>::recombine(double CR, const vector<int> &var, int I) {
	...
	template<typename VariableEncoding = variable<real>,
		typename ObjetiveType = real,
		typename ObjetiveCompare = objective_compare<ObjetiveType >>
	evaluation_tag DE_individual<VariableEncoding, ObjetiveType, ObjetiveCompare>::select(const vector<int> &var, solution_type &best) {
		int dim = GET_NUM_DIM;
