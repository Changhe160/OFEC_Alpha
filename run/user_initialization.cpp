...
namespace OFEC {
	...
	void register_problem() {
		...
		/*combination*/
		RIGIESTER(problem, multi_dimensional_knapsack, "MKP", std::set<problem_tag>({ problem_tag::MKP, problem_tag::COMB }));
		RIGIESTER(problem, one_max, "One_Max", std::set<problem_tag>({ problem_tag::ONEMAX, problem_tag::COMB }));
		RIGIESTER(problem, quadratic_assignment, "QAP", std::set<problem_tag>({ problem_tag::QAP, problem_tag::COMB }));
		RIGIESTER(problem, travelling_salesman, "TSP", std::set<problem_tag>({ problem_tag::TSP, problem_tag::COMB }));
		/*multi_objective*/
	...
	void register_algorithm() {
		RIGIESTER(algorithm, NSGAII, "NSGAII", std::set<problem_tag>({ problem_tag::MOP,problem_tag::CONT }));
		...
		RIGIESTER(algorithm, ADOPT, "ADOPT", std::set<problem_tag>({ problem_tag::epanet }));
	}
