...
namespace OFEC {
	...
	void register_problem() {
		...
		/*realworld*/
		RIGIESTER(problem, gear_train, "FGear_Train", std::set<problem_tag>({ problem_tag::GOP,problem_tag::CONT }));
		RIGIESTER(problem, par_est_FM_sound_waves, "FParEst_FMSoundWaves", std::set<problem_tag>({ problem_tag::GOP,problem_tag::CONT }));
		//RIGIESTER(problem, epanet, "epanet", std::set<problem_tag>({ problem_tag::GOP }));
	}

	void register_algoritm() {
