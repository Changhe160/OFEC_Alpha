...
namespace OFEC {
	...
	template <typename Population1, typename Population2, typename Individual>
	LRM_ADOPT<Population1, Population2, Individual>::LRM_ADOPT(param_map & v) : algorithm(v.at("algName")), \
	...
	template <typename Population1, typename Population2, typename Individual>
	evaluation_tag LRM_ADOPT<Population1, Population2, Individual>::evolve() {
	...
	void LRM_ADOPT<Population1, Population2, Individual>::output() {
		...
		path << global::ms_arg.at("workingDir") << "result/new/Alg4Epa/LRM_ADOPT/" << m_path_result;
		...
		path2 << global::ms_arg.at("workingDir") << "result/new/Alg4Epa/LRM_ADOPT/NET2_97/20w/curr_best_obj.txt";
	...
	void LRM_ADOPT<Population1, Population2, Individual>::local_search(Population & pop) {  // 0.2 0.5 0.8
		std::vector<real> beta = { 0.8, 0.5, 0.2 };
