...
namespace OFEC {
	...
	class DEindividual : public individual<VariableEncoding, ObjetiveType>
	{
	public:
		template<class, class> friend class DE_population;
		
		using solution_type = solution<VariableEncoding, ObjetiveType>;
		using individual_type = individual<VariableEncoding, ObjetiveType>;
	protected:
	...
	template<typename VariableEncoding = variable<real>,
		typename ObjetiveType = real>
	DEindividual<VariableEncoding, ObjetiveType> & 
		DEindividual<VariableEncoding, ObjetiveType>::operator=(const DEindividual &rhs) {
	...
	template<typename VariableEncoding = variable<real>,
		typename ObjetiveType = real>
	DEindividual<VariableEncoding, ObjetiveType> &
		DEindividual<VariableEncoding, ObjetiveType>::operator=(DEindividual &&rhs) {
		if (this == &rhs) return *this;
	...
	template<typename VariableEncoding = variable<real>,
		typename ObjetiveType = real>
	void DEindividual<VariableEncoding, ObjetiveType>::mutate(double F, 
		solution_type *r1,
		solution_type *r2,
		solution_type *r3,
		solution_type *r4,
	...
	template<typename VariableEncoding = variable<real>,
		typename ObjetiveType = real>
	void DEindividual<VariableEncoding, ObjetiveType>::recombine(double CR) {
	...
	template<typename VariableEncoding = variable<real>,
		typename ObjetiveType = real>
	void DEindividual<VariableEncoding, ObjetiveType>::mutate(double F, const std::vector<int> &var, 
		solution_type *r1,
		solution_type *r2,
		solution_type *r3,
		solution_type *r4,
	...
	template<typename VariableEncoding = variable<real>,
		typename ObjetiveType = real>
	void DEindividual<VariableEncoding, ObjetiveType>::recombine(double CR, const std::vector<int> &var, int I) {
	...
	template<typename VariableEncoding = variable<real>,
		typename ObjetiveType = real>
	evaluation_tag DEindividual<VariableEncoding, ObjetiveType>::select(const std::vector<int> &var, solution_type &best) {
		int dim = GET_NUM_DIM;
	...
	template<typename VariableEncoding = variable<real>,
		typename ObjetiveType = real>
		solution<VariableEncoding, ObjetiveType> & DEindividual<VariableEncoding, ObjetiveType>::trial() {
		return m_pu;
	}
