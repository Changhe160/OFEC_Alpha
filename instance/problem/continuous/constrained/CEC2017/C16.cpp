...
namespace OFEC {
	namespace CEC2017 {
<<<<<<< HEAD
		C16::C16(param_map &v) :problem((v.at("proName")), (v.at("numDim")), 1), \
			function((v.at("proName")), (v.at("numDim")), 1) {
=======
		C16::C16(param_map &v) :
			C16((v.at("proName")), (v.at("numDim")), 1) {
>>>>>>> zhou_li
...
>>>>>>> zhou_li
		...
		void C16::evaluate__(real *x, std::vector<real>& obj, double & cons_value, std::vector<double> &cons_values) {
