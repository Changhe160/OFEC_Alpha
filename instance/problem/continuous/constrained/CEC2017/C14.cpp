...
namespace OFEC {
	namespace CEC2017 {
		C14::C14(param_map &v) :problem((v[param_proName]), (v[param_numDim]), 1), \
		...
		void C14::evaluate__(real *x, std::vector<real>& obj, double & cons_first, std::vector<double> &cons_second) {
