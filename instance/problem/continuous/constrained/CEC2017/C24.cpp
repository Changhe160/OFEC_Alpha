...
namespace OFEC {
	namespace CEC2017 {
		...
		void C24::initialize() {
			...
			load_translation("instance/problem/continuous/constrained/CEC2417/data/");  //data path
			
			load_rotation("instance/problem/continuous/constrained/CEC2417/data/");
			
		}
		void C24::evaluate__(real *x, std::vector<real>& obj, double & cons_value, std::vector<double> &cons_values) {
