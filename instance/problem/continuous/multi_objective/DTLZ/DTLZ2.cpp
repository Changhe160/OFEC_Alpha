...
namespace OFEC {
	DTLZ2::DTLZ2(param_map & v) : 
		DTLZ2(v.at("proName"), (v.at("numObj") + v.at("interTest1") - 1), v.at("numObj")) { // param_interTest1 = 10 is recommended
	}
	...
	void DTLZ2::evaluate_objective(real *x, std::vector<real> &obj) {
		real g = 0;
