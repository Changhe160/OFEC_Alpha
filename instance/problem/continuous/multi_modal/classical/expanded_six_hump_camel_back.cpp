...
namespace OFEC {
	...
	expanded_six_hump_camel_back::expanded_six_hump_camel_back(param_map &v) :problem((v.at("proName")), (v.at("numDim")), 1), \
	...
	void expanded_six_hump_camel_back::initialize_problem() {
		set_range(-40., 40.);
