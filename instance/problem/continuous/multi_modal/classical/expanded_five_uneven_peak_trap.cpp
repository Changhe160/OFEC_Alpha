...
<<<<<<< HEAD
	expanded_five_uneven_peak_trap::expanded_five_uneven_peak_trap(param_map &v) :problem((v.at("proName")), (v.at("numDim")), 1), \
		function((v.at("proName")), (v.at("numDim")), 1) {
=======
	expanded_five_uneven_peak_trap::expanded_five_uneven_peak_trap(param_map &v) :
		expanded_five_uneven_peak_trap((v.at("proName")), (v.at("numDim")), 1) {
>>>>>>> zhou_li
