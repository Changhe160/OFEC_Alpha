...
namespace OFEC {
	namespace CEC2015 {
		F13_composition2015_C5::F13_composition2015_C5(param_map &v) :
			F13_composition2015_C5((v.at("proName")), (v.at("numDim")), 1) {
		...
		bool F13_composition2015_C5::load_translation(const std::string &path) {
			std::string s;
			std::stringstream ss;
			ss << ".txt";
			s = ss.str();
		...
		void F13_composition2015_C5::set_translation() {
		...
		void F13_composition2015_C5::set_weight(std::vector<double>& weight, const std::vector<real>&x) {
