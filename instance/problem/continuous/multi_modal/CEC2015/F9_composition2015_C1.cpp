...
namespace OFEC {
	namespace CEC2015 {
<<<<<<< HEAD
		F9_composition2015_C1::F9_composition2015_C1(param_map &v) :problem((v.at("proName")), (v.at("numDim")), 1), \
			composition_2015((v.at("proName")), (v.at("numDim")), 1) {
=======
		F9_composition2015_C1::F9_composition2015_C1(param_map &v) :
			F9_composition2015_C1((v.at("proName")), (v.at("numDim")), 1) {
>>>>>>> zhou_li
		...
		void F9_composition2015_C1::set_function() {
			basic_func f(5);
		...
		void F9_composition2015_C1::evaluate__(real *x, std::vector<real>& obj) {
		...
		bool F9_composition2015_C1::load_translation(const std::string &path) {
			std::string s;
			std::stringstream ss;
			ss << ".txt";
			s = ss.str();
		...
		void F9_composition2015_C1::set_translation() {
		...
		void F9_composition2015_C1::set_weight(std::vector<double>& weight, const std::vector<real>&x) {
