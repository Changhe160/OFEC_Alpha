...
namespace OFEC {
	namespace CEC2015 {
		F15_composition2015_C7::F15_composition2015_C7(param_map &v) :
			F15_composition2015_C7((v.at("proName")), (v.at("numDim")), 1) {
		...
		void F15_composition2015_C7::evaluate_objective(real *x, std::vector<real> &obj) {
