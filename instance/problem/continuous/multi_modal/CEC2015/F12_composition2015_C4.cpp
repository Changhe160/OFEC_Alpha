...
namespace OFEC {
	namespace CEC2015 {
		F12_composition2015_C4::F12_composition2015_C4(param_map &v) :
			F12_composition2015_C4((v.at("proName")), (v.at("numDim")), 1) {
		...
		void F12_composition2015_C4::set_function() {
			basic_func f(5);
		...
		void F12_composition2015_C4::evaluate__(real *x, std::vector<real>& obj) {
		...
		bool F12_composition2015_C4::load_translation(const std::string &path) {
			std::string s;
			std::stringstream ss;
			ss << ".txt";
			s = ss.str();
		...
		void F12_composition2015_C4::set_translation() {
		...
		void F12_composition2015_C4::set_weight(std::vector<double>& weight, const std::vector<real>&x) {
