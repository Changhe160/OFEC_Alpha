...
namespace OFEC {
	namespace CEC2013 {
		N20_ShiftedSchwefel_F11::N20_ShiftedSchwefel_F11(param_map &v) : problem((v[param_proName]), (v[param_numDim]), 1), \
		...
		void N20_ShiftedSchwefel_F11::evaluate__(real *x, std::vector<real>& obj) {
			size_t i;
			double result = 0.0;
