...
namespace OFEC {
	namespace CEC2015 {
		F7_hybrid2::F7_hybrid2(param_map &v) :
			F7_hybrid2((v.at("proName")), (v.at("numDim")), 1) {
		...
		void F7_hybrid2::evaluate_objective(real *x, std::vector<real> &obj) {
