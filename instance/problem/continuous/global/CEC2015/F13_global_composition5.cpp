...
namespace OFEC {
	namespace CEC2015 {
		F13_global_composition5::F13_global_composition5(param_map &v) :
			F13_global_composition5((v.at("proName")), (v.at("numDim")), 1) {
		...
		void F13_global_composition5::evaluate_objective(real *x, std::vector<real> &obj) {
