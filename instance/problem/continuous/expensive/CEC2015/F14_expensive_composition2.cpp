...
namespace OFEC {
	namespace CEC2015 {
		F14_expensive_composition2::F14_expensive_composition2(param_map &v) :
			F14_expensive_composition2((v.at("proName")), (v.at("numDim")), 1) {
		...
		void F14_expensive_composition2::set_function() {
			basic_func f(3);
		...
		void F14_expensive_composition2::evaluate_objective(real *x, std::vector<real> &obj) {
