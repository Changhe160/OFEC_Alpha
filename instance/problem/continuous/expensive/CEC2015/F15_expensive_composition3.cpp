...
namespace OFEC {
	namespace CEC2015 {
		F15_expensive_composition3::F15_expensive_composition3(param_map &v) :problem((v[param_proName]), (v[param_numDim]), 1), \
		...
		void F15_expensive_composition3::evaluate__(real *x, std::vector<real>& obj) {
