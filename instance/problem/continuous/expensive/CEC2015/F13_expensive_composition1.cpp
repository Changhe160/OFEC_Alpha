...
namespace OFEC {
	namespace CEC2015 {
		F13_expensive_composition1::F13_expensive_composition1(param_map &v) :problem((v[param_proName]), (v[param_numDim]), 1), \
		...
		void F13_expensive_composition1::set_function() {
			basic_func f(5);
